...
% <multi/many> <real> <constrained/none> <large/none> <sparse>
% Nondominated sorting genetic algorithm III Sparse

%------------------------------- Reference --------------------------------
% X. Wang, R. Cheng and Y. Jin, "Sparse Large-Scale Multiobjective 
% Optimization by Identifying Nonzero Decision Variables," in IEEE 
